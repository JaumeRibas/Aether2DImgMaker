...
public class ColorMappedSymmetricIntGrid2D extends SymmetricColorGrid2D {

	protected SymmetricIntGrid2D grid;
	protected LongColorMap colorMap;
	
	public ColorMappedSymmetricIntGrid2D(SymmetricIntGrid2D grid, LongColorMap colorMap) {
		this.grid = grid;
