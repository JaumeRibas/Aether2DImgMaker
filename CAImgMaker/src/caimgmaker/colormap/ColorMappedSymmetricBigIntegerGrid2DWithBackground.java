...
public class ColorMappedSymmetricBigIntegerGrid2DWithBackground extends ColorMappedSymmetricBigIntegerGrid2D {

	protected BigInteger backgroundValue;
	protected Color backgroundColor;
	
	public ColorMappedSymmetricBigIntegerGrid2DWithBackground(SymmetricBigIntegerGrid2D grid, BigIntegerColorMap colorMap, 
	...
	public Color getNonSymmetricColorAt(int x, int y) {
		BigInteger value = grid.getNonSymmetricValueAt(x, y);
		if (value.equals(backgroundValue)) {
			return backgroundColor;
		}
		return colorMap.getColor(value);
