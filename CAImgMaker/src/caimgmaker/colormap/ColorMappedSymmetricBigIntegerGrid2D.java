...
public class ColorMappedSymmetricBigIntegerGrid2D extends SymmetricColorGrid2D {

	protected SymmetricBigIntegerGrid2D grid;
	protected BigIntegerColorMap colorMap;
	
	public ColorMappedSymmetricBigIntegerGrid2D(SymmetricBigIntegerGrid2D grid, BigIntegerColorMap colorMap) {
		this.grid = grid;
