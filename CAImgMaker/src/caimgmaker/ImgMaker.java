...
public class ImgMaker {
	...
	public <Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> void createEvenOddImages(NumericModel2D<Number_Type> ca, ColorMapper colorMapper, 
		...
		do {
			...
			if (!omitEven) {
				MinAndMax<Number_Type> evenMinAndMaxValue = ca.getEvenOddPositionsMinAndMax(true);			
				if (evenMinAndMaxValue != null) {
			...
			if (!omitOdd) {
				MinAndMax<Number_Type> oddMinAndMaxValue = ca.getEvenOddPositionsMinAndMax(false);
				if (oddMinAndMaxValue != null) {
	...
	public <Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> void createScanningAndZCrossSectionEvenOddImages(NumericModel3D<Number_Type> ca, int[] scanInitialCoords, int crossSectionZ, 
		...
		do {
			...
			System.out.println("Scan " + ca.getXLabel() + ": " + scanCoords[0]);
			if (!omitEven) {
				MinAndMax<Number_Type> evenScanMinAndMaxValue = crossSection.getEvenOddPositionsMinAndMax(true);
				if (evenScanMinAndMaxValue != null) {
			...
			if (!omitOdd) {
				MinAndMax<Number_Type> oddScanMinAndMaxValue = crossSection.getEvenOddPositionsMinAndMax(false);
				if (oddScanMinAndMaxValue != null) {
			...
			crossSection = ca.crossSectionAtZ(crossSectionZ);
			if (!omitEven) {
				MinAndMax<Number_Type> evenCrossSectionMinAndMaxValue = crossSection.getEvenOddPositionsMinAndMax(true);
				if (evenCrossSectionMinAndMaxValue != null) {
			...
			if (!omitOdd) {
				MinAndMax<Number_Type> oddCrossSectionMinAndMaxValue = crossSection.getEvenOddPositionsMinAndMax(false);
				if (oddCrossSectionMinAndMaxValue != null) {
