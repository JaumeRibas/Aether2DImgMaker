...
import cellularautomata.automata.nearaether.NearAether4Simple3D;

public class NearAether4_3DImgMaker {
	
	public static void main(String[] args) throws Exception {
		args = new String[]{"-100000", "D:/data/test"};//, "150", "30", "10000"};//debug
		if (args.length == 0) {
			...
			NearAether4Simple3D ca;
			ca = new NearAether4Simple3D(initialValue);
