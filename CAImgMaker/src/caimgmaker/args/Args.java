...
public class Args {
	...
	@Parameter(names = "-first-step", validateWith = NonNegativeIntegerValidator.class, description = "The app skips ahead to this step without generating images. If the first step provided is greater than the model's last step, the app will stop a the last step plus one.")
	...
	@Parameter(names = { "-no-folders", "-no-folder" }, description = "Do not create a subfolder structure at the -path aside from numbered folders.")
	...
	@Parameter(names = "-restore", description = "The path of a backup to restore.")
    public String backupToRestorePath = null;
	
	@Parameter(names = "-scan1-start", description = "The scan1 will start at this coordinate. Only applies to model sections with dimension three (see the -grid and -coordinate-filters parameters).")
    public Integer xScanInitialIndex = null;
    
	@Parameter(names = "-scan2-start", description = "The scan2 will start at this coordinate. Only applies to model sections with dimension three (see the -grid and -coordinate-filters parameters).")
    public Integer yScanInitialIndex = null;
    
	@Parameter(names = "-scan3-start", description = "The scan3 will start at this coordinate. Only applies to model sections with dimension three (see the -grid and -coordinate-filters parameters).")
