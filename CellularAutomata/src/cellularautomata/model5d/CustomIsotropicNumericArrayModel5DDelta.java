...
public class CustomIsotropicNumericArrayModel5DDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements IsotropicHypercubicNumericModelAsymmetricSection5D<Number_Type> {	

	private final IsotropicHypercubicNumericArrayModelAsymmetricSection5D<Number_Type> model;
	private Number_Type[][][][][] oldGrid;
	private int size;

	public CustomIsotropicNumericArrayModel5DDelta(IsotropicHypercubicNumericArrayModelAsymmetricSection5D<Number_Type> model) throws Exception {
		this.model = model;
		nextStep();
	}
