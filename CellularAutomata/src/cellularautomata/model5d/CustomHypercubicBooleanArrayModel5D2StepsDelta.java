...
public class CustomHypercubicBooleanArrayModel5D2StepsDelta implements SymmetricBooleanModel5D, IsotropicHypercubicModel5DA {	

	private boolean[][][][][] previousStepGrid;
	private boolean[][][][][] stepBeforePreviousGrid;
	private IsotropicHypercubicBooleanArrayModel5DA model;
	private int sizeDifference;

	public CustomHypercubicBooleanArrayModel5D2StepsDelta(IsotropicHypercubicBooleanArrayModel5DA model) throws Exception {
		this.model = model;
	...
	public boolean getFromAsymmetricPosition(int v, int w, int x, int y, int z) {
		return model.grid[v][w][x][y][z] != stepBeforePreviousGrid[v][w][x][y][z];
	}
