...
public class CustomHypercubicIntArrayModel5DDelta implements SymmetricLongModel5D, IsotropicHypercubicModel5DA {	

	private int[][][][][] oldGrid;
	private IsotropicHypercubicIntArrayModel5DA model;
	private int sizeDifference;

	public CustomHypercubicIntArrayModel5DDelta(IsotropicHypercubicIntArrayModel5DA model) throws Exception {
		this.model = model;
		nextStep();
	}
