...
public class CustomHypercubicBooleanArrayModel5DDelta implements SymmetricBooleanModel5D, IsotropicHypercubicModel5DA {	

	private boolean[][][][][] oldGrid;
	private IsotropicHypercubicBooleanArrayModel5DA model;
	private int sizeDifference;

	public CustomHypercubicBooleanArrayModel5DDelta(IsotropicHypercubicBooleanArrayModel5DA model) throws Exception {
		this.model = model;
		nextStep();
	}
