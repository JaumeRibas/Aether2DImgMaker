...
public class CustomHypercubicNumericArrayModel5D2StepsDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements SymmetricNumericModel5D<Number_Type>, IsotropicHypercubicModel5DA {	
	...
	public CustomHypercubicNumericArrayModel5D2StepsDelta(IsotropicHypercubicNumericArrayModel5DA<Number_Type> model) throws Exception {
		this.model = model;
