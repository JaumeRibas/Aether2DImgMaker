...
public class HyperrectangularLongArrayGrid5D extends HyperrectangularArrayGrid5D implements LongModel5D {
	 ...
	 * @param values a 5D long array containing the values of the region
	 */
	public HyperrectangularLongArrayGrid5D(int minV, int minW, int minX, int minY, int minZ, long[][][][][] values) {
