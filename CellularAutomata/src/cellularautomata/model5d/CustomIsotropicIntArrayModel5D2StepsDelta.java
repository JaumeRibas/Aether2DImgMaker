...
public class CustomIsotropicIntArrayModel5D2StepsDelta implements IsotropicHypercubicLongModelAsymmetricSection5D {	
	...
	public CustomIsotropicIntArrayModel5D2StepsDelta(IsotropicHypercubicIntArrayModelAsymmetricSection5D model) throws Exception {
		this.model = model;
