...
public class CustomHypercubicLongArrayModel5DDelta implements SymmetricNumericModel5D<BigInt>, IsotropicHypercubicModel5DA {	

	private long[][][][][] oldGrid;
	private IsotropicHypercubicLongArrayModel5DA model;
	private int sizeDifference;

	public CustomHypercubicLongArrayModel5DDelta(IsotropicHypercubicLongArrayModel5DA model) throws Exception {
		this.model = model;
		nextStep();
	}
