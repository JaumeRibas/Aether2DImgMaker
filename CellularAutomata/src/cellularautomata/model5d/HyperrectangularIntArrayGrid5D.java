...
public class HyperrectangularIntArrayGrid5D extends HyperrectangularArrayGrid5D implements IntModel5D {
	 ...
	 * @param values a 5D int array containing the values of the region
	 */
	public HyperrectangularIntArrayGrid5D(int minV, int minW, int minX, int minY, int minZ, int[][][][][] values) {
