...
public class CustomHypercubicLongArrayModel5D2StepsDelta implements SymmetricNumericModel5D<BigInt>, IsotropicHypercubicModel5DA {	

	private long[][][][][] previousStepGrid;
	private long[][][][][] stepBeforePreviousGrid;
	private IsotropicHypercubicLongArrayModel5DA model;
	private int sizeDifference;

	public CustomHypercubicLongArrayModel5D2StepsDelta(IsotropicHypercubicLongArrayModel5DA model) throws Exception {
		this.model = model;
	...
	@Override
	public BigInt getFromAsymmetricPosition(int v, int w, int x, int y, int z) {
