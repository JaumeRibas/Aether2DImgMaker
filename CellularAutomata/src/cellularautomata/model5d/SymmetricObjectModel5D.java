...
public interface SymmetricObjectModel5D<Object_Type> extends ObjectModel5D<Object_Type>, SymmetricModel5D, SymmetricObjectModel<Object_Type> {
	 ...
	 * @throws Exception 
	 */
	Object_Type getFromAsymmetricPosition(int v, int w, int x, int y, int z) throws Exception;
	...
	@Override
	default ObjectModel5D<Object_Type> asymmetricSection() {
		return new AsymmetricObjectModelSection5D<SymmetricObjectModel5D<Object_Type>, Object_Type>(this);
	}
}
