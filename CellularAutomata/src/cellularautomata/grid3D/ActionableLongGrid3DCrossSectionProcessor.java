...
public class ActionableLongGrid3DCrossSectionProcessor extends ActionableGrid<GridProcessor<LongGrid2D>, LongGrid2D> implements GridProcessor<LongGrid3D> {
	...
	public ActionableLongGrid3DCrossSectionProcessor(ActionableGrid<GridProcessor<LongGrid3D>, LongGrid3D> source, int z) {
		this.source = source;
		this.z = z;
	}
