...
public class AbsSymmetricShortGrid3D implements SymmetricShortGrid3D {
	...
	@Override
	public short getValueAtNonSymmetricPosition(int x, int y, int z) {
		return (short) Math.abs(source.getValueAtNonSymmetricPosition(x, y, z));
	}
