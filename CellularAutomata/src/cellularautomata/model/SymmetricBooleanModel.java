...
public interface SymmetricBooleanModel extends BooleanModel, SymmetricModel {
	
	@Override
	default BooleanModel asymmetricSection() {
		return new AsymmetricBooleanModelSection<SymmetricBooleanModel>(this);
	}
	 ...
	 * @throws Exception 
	 */
	boolean getFromAsymmetricPosition(Coordinates coordinates) throws Exception;
	
	/**
	 * Feeds every value of an asymmetric section, in a consistent order, to an {@link Consumer}.
	 * @param consumer
	 */
	default void forEachInAsymmetricSection(Consumer<? super Boolean> consumer) {
