...
public class LongModelEvenOddMinAndMaxProcessor<G extends LongModel> implements ModelProcessor<G> {
	...
	@Override
	public void processModelBlock(G gridBlock) throws Exception {
		//even
