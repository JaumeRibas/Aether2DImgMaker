...
public interface SymmetricObjectModel<Object_Type> extends ObjectModel<Object_Type>, SymmetricModel {
	
	@Override
	default ObjectModel<Object_Type> asymmetricSection() {
		return new AsymmetricObjectModelSection<SymmetricObjectModel<Object_Type>, Object_Type>(this);
	}
	 ...
	 * @throws Exception 
	 */
	Object_Type getFromAsymmetricPosition(Coordinates coordinates) throws Exception;
