...
public class BigFractionGrid3DPattern implements NumberGrid3D<BigFraction> {

	protected NumberGrid3D<BigFraction> source;
	protected BigFraction min;
	protected BigFraction range;
	
	public BigFractionGrid3DPattern(NumberGrid3D<BigFraction> grid) throws Exception {
		this.source = grid;
