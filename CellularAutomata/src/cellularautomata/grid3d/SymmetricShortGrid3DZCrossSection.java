...
public class SymmetricShortGrid3DZCrossSection implements SymmetricShortGrid2D {

	private SymmetricShortGrid3D source;
	private int z;
	
	public SymmetricShortGrid3DZCrossSection(SymmetricShortGrid3D source, int z) {
		this.source = source;
		this.z = z;
	}
