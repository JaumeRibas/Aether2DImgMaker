...
public class AsymmetricGridSection3D<G extends SymmetricGrid3D> extends AsymmetricGridSection<G> implements Grid3D {

	public AsymmetricGridSection3D(G source) {
		super(source);
	}
