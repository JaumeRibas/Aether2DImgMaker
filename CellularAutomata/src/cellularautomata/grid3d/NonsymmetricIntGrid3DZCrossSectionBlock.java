...
public class NonsymmetricIntGrid3DZCrossSectionBlock implements Serializable, IntGrid2D {
	...
	public NonsymmetricIntGrid3DZCrossSectionBlock(IntGrid3D block, int z) throws Exception {
		if (z < 0) {
