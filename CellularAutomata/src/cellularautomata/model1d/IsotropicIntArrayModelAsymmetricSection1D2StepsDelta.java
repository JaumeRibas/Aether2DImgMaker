...
public class IsotropicIntArrayModelAsymmetricSection1D2StepsDelta implements IsotropicLongModelAsymmetricSection1D {	

	private final IsotropicIntArrayModelAsymmetricSection1D model;
	...
	public IsotropicIntArrayModelAsymmetricSection1D2StepsDelta(IsotropicIntArrayModelAsymmetricSection1D model) throws Exception {
		this.model = model;
	...
	public long getFromPosition(int x) {
		return (long)model.grid[x] - stepBeforePreviousGrid[x];
	}
