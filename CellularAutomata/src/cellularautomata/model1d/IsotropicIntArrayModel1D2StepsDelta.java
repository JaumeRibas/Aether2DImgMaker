...
public class IsotropicIntArrayModel1D2StepsDelta implements SymmetricLongModel1D, IsotropicModel1DA {	

	private int[] previousStepGrid;
	private int[] stepBeforePreviousGrid;
	private IsotropicIntArrayModel1DA model;
	private int sizeDifference;

	public IsotropicIntArrayModel1D2StepsDelta(IsotropicIntArrayModel1DA model) throws Exception {
		this.model = model;
