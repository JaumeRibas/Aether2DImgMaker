...
public class IsotropicIntArrayModel1DDelta implements SymmetricLongModel1D, IsotropicModel1DA {	

	private int[] oldGrid;
	private IsotropicIntArrayModel1DA model;
	private int sizeDifference;

	public IsotropicIntArrayModel1DDelta(IsotropicIntArrayModel1DA model) throws Exception {
		this.model = model;
		nextStep();
	}
