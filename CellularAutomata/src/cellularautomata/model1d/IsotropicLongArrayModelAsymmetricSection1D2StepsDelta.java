...
public class IsotropicLongArrayModelAsymmetricSection1D2StepsDelta implements IsotropicNumericModelAsymmetricSection1D<BigInt> {	
	...
	public IsotropicLongArrayModelAsymmetricSection1D2StepsDelta(IsotropicLongArrayModelAsymmetricSection1D model) throws Exception {
		this.model = model;
