...
public class IntAether4D implements SymmetricEvolvingIntGrid4D, Serializable {
	...
	public boolean nextStep(){
		...
		int[][][][] currentWSlices = new int[][][][] { smallerWSlice, currentWSlice, greaterWSlice};
		newSmallerWSlice = newCurrentWSlice;
		newCurrentWSlice = newGreaterWSlice;
	...
	private boolean toppleRangeBeyondW4(int[][][][] currentWSlices, int[][][][] newWSlices, int[][][][] newGrid, int minW,
		...
		int[][][] smallerWSlice = null, currentWSlice = currentWSlices[1], greaterWSlice = currentWSlices[2];
	...
	private static boolean toppleRangeType1(int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
		...
		boolean changed = false;
		int[][][] smallerWSlice = currentWSlices[0], currentWSlice = currentWSlices[1], greaterWSlice = currentWSlices[2];
	//  w | 00 | 00 | 00 | 06
		int currentValue = currentWSlice[0][0][0];
		int greaterWNeighborValue = greaterWSlice[0][0][0];
	...
	private static boolean toppleRangeType2(int x, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
		int xMinusOne = x - 1;
		boolean changed = false;
		int[][][] currentWSlice = currentWSlices[1], greaterWSlice = currentWSlices[2];		
	//  w |  x | 00 | 00 | 10
	...
	private static boolean toppleRangeType3(int coord, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
	...
	private static boolean toppleRangeType4(int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
		boolean changed = false;
	...
	private static boolean toppleRangeType5(int x, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
	...
	private static boolean toppleRangeType6(int coord, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
	...
	private static boolean toppleRangeType7(int x, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {		
	...
	private static boolean toppleRangeType8(int x, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
		int xMinusOne = x - 1, xPlusOne = x + 1;
		boolean changed = false;
		int[][][] smallerWSlice = currentWSlices[0], currentWSlice = currentWSlices[1], greaterWSlice = currentWSlices[2];		
	...
	private static boolean toppleRangeType9(int coord, int[][][][] currentWSlices, int[][][][] newWSlices, int[] relevantAsymmetricNeighborValues,
			int[][] relevantAsymmetricNeighborCoords, int[] relevantAsymmetricNeighborSymmetryCounts, int[] relevantAsymmetricNeighborShareMultipliers) {
		int coordMinusOne = coord - 1, coordPlusOne = coord + 1;
		boolean changed = false;
		int[][][] smallerWSlice = currentWSlices[0], currentWSlice = currentWSlices[1], greaterWSlice = currentWSlices[2];
