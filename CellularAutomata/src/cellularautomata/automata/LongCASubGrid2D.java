...
public class LongCASubGrid2D implements LongCellularAutomaton2D {
	
	private LongCellularAutomaton2D ca;
	private LongGrid2D subGrid;
	
	public LongCASubGrid2D(LongCellularAutomaton2D ca, int minX, int maxX, int minY, int maxY) {
		this.ca = ca;
