 ...
 *
 */
public class LongSunflower2D extends IsotropicSquareLongArrayModelAsymmetricSection {
	 ...
	 */
	public LongSunflower2D(long initialValue) {
	...
	private boolean toppleRangeBeyondX2(long[][] newGrid, int minX, int maxX) {
