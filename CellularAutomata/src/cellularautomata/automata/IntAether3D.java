...
public class IntAether3D implements SymmetricEvolvingIntGrid3D {
	...
	private static boolean topplePosition(int[][][] newXSlices, int value, int y, int z, int[] aymmetricNeighborValues,
		...
		switch (asymmetricNeighborCount) {
			case 3:
				...
				break;
			case 2:
				int n0Val = aymmetricNeighborValues[0], n1Val = aymmetricNeighborValues[1];
