 ...
 *
 */
public class LongAether3DBoundedGrid implements LongModel3D, Serializable {
	 ...
	 * @param singleSourceZ
	 */
	public LongAether3DBoundedGrid(int xSide, int ySide, int zSide, 
	 ...
	 */
	public LongAether3DBoundedGrid(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		LongAether3DBoundedGrid data = (LongAether3DBoundedGrid) Utils.deserializeFromFile(backupPath);
		grid = data.grid;
