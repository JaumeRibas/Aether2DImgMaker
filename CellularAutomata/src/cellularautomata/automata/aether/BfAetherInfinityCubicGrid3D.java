 ...
 *
 */
public class BfAetherInfinityCubicGrid3D implements SymmetricNumericModel3D<BigFraction>, Serializable {
	...
	public BfAetherInfinityCubicGrid3D(boolean isPositive, int side) {
		if (side%2 == 0)
	 ...
	 */
	public BfAetherInfinityCubicGrid3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		BfAetherInfinityCubicGrid3D data = (BfAetherInfinityCubicGrid3D) Utils.deserializeFromFile(backupPath);
