 ...
 *
 */
public class LongAether3D implements SymmetricLongModel3D, IsotropicCubicModelA, Serializable {
...
//	private static HashSet<Integer> coverage = new HashSet<Integer>();
	 ...
	 */
	public LongAether3D(long initialValue) {
	 ...
	 */
	public LongAether3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		...
		if (!SerializableModelData.InitialConfigurationTypes.SINGLE_SOURCE_AT_ORIGIN.equals(data.get(SerializableModelData.INITIAL_CONFIGURATION_TYPE))
			...
			throw new IllegalArgumentException("The backup file's configuration is not compatible with the " + LongAether3D.class + " class.");
		}
