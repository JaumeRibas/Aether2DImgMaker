 ...
 *
 */
public class LongAetherCubicGrid3D implements SymmetricLongModel3D, Serializable {
	 ...
	 * @param initialValue
	 */
	public LongAetherCubicGrid3D(int side, long initialValue) {
		if (side%2 == 0)
	 ...
	 */
	public LongAetherCubicGrid3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		LongAetherCubicGrid3D data = (LongAetherCubicGrid3D) Utils.deserializeFromFile(backupPath);
		grid = data.grid;
