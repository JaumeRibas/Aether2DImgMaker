 ...
 *
 */
public class BfAetherInfinityBoundedGridCenterSource1D implements SymmetricNumericModel1D<BigFraction>, Serializable {
	...
	public BfAetherInfinityBoundedGridCenterSource1D(int size, boolean isPositive) {
		if (size%2 == 0)
	 ...
	 */
	public BfAetherInfinityBoundedGridCenterSource1D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		BfAetherInfinityBoundedGridCenterSource1D data = (BfAetherInfinityBoundedGridCenterSource1D) Utils.deserializeFromFile(backupPath);
