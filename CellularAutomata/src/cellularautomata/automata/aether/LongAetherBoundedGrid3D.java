 ...
 *
 */
public class LongAetherBoundedGrid3D implements LongModel3D, Serializable {
	 ...
	 * @param singleSourceZ
	 */
	public LongAetherBoundedGrid3D(int xSide, int ySide, int zSide, 
	 ...
	 */
	public LongAetherBoundedGrid3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		LongAetherBoundedGrid3D data = (LongAetherBoundedGrid3D) Utils.deserializeFromFile(backupPath);
		grid = data.grid;
