...
public class IntAetherTopplingAlternationCompliance3D extends IsotropicCubicBooleanArrayModelAsymmetricSection {
	 ...
	 */
	public IntAetherTopplingAlternationCompliance3D(int initialValue) {
		...
		sourceGrid = Utils.buildAnisotropic3DIntArray(7);
	 ...
	 */
	public IntAetherTopplingAlternationCompliance3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
	...
	public Boolean nextStep() {
		...
		int[][] smallerXSlice = null, currentXSlice = sourceGrid[0], greaterXSlice = sourceGrid[1];
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newSourceGrid[sourceGrid.length] = Utils.buildAnisotropic2DIntArray(newSourceGrid.length);
		}
	...
	private boolean toppleRangeBeyondX3(int[][][] xSlices, int[][][] newXSlices, int[][][] newSourceGrid, int minX, int maxX, 
