 ...
 *
 */
public class SimpleBfAetherInfinityBoundedGrid1D implements NumericModel1D<BigFraction> {
	...
	public SimpleBfAetherInfinityBoundedGrid1D(int size, boolean isPositive, int singleSourceX) {
		if (size < 1) {
