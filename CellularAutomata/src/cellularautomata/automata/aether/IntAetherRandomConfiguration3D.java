 ...
 *
 */
public class IntAetherRandomConfiguration3D implements IntModel3D, Serializable {	
	 ...
	 */
	public IntAetherRandomConfiguration3D(int initialSide, int minValue, int maxValue) {
	 ...
	 */
	public IntAetherRandomConfiguration3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		IntAetherRandomConfiguration3D data = (IntAetherRandomConfiguration3D) Utils.deserializeFromFile(backupPath);
		grid = data.grid;		
