 ...
 *
 */
public class SimpleBfAether1DInfinityBoundedGrid implements NumericModel1D<BigFraction> {
	...
	public SimpleBfAether1DInfinityBoundedGrid(int size, boolean isPositive, int singleSourceX) {
		if (size < 1) {
