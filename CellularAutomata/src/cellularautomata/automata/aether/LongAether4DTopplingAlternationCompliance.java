...
public class LongAether4DTopplingAlternationCompliance implements SymmetricBooleanModel4D, IsotropicHypercubicModel4DA, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1395524274237968117L;
	 ...
	 */
	public LongAether4DTopplingAlternationCompliance(long initialValue) {
	 ...
	 */
	public LongAether4DTopplingAlternationCompliance(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		LongAether4DTopplingAlternationCompliance data = (LongAether4DTopplingAlternationCompliance) Utils.deserializeFromFile(backupPath);
