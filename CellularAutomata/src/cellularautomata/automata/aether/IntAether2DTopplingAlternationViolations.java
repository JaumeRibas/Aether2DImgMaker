...
public class IntAether2DTopplingAlternationViolations implements SymmetricBooleanModel2D, IsotropicSquareModelA, Serializable {
	 ...
	 */
	public IntAether2DTopplingAlternationViolations(int initialValue) {
	 ...
	 */
	public IntAether2DTopplingAlternationViolations(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		IntAether2DTopplingAlternationViolations data = (IntAether2DTopplingAlternationViolations) Utils.deserializeFromFile(backupPath);
	...
	public Boolean nextStep() {
		...
		grid = newGrid;
		step++;
		this.topplingAlternationOffset = !this.topplingAlternationOffset;
