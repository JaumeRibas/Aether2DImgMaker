 ...
 *
 */
public class SimpleBfAetherInfinity2D implements IsotropicSquareNumericModelAsymmetricSection<BigFraction> {
	...
	public SimpleBfAetherInfinity2D(boolean isPositive) {
