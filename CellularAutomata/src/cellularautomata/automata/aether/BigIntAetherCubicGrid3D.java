 ...
 *
 */
public class BigIntAetherCubicGrid3D implements SymmetricNumericModel3D<BigInt>, Serializable {
	...
	public BigIntAetherCubicGrid3D(int side, BigInt initialValue) {
		if (side%2 == 0)
	 ...
	 */
	public BigIntAetherCubicGrid3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		BigIntAetherCubicGrid3D data = (BigIntAetherCubicGrid3D) Utils.deserializeFromFile(backupPath);
