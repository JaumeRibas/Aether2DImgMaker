...
public class AetherInfinityTopplingAlternationCompliance2D extends IsotropicSquareBooleanArrayModelA {
	...
	public AetherInfinityTopplingAlternationCompliance2D(boolean isPositive) {
		this.isPositive = isPositive;
		final int side = 6;
		sourceGrid = Utils.buildAnisotropic2DBigFractionArray(side);
		sourceGrid[0][0] = isPositive? BigFraction.ONE : BigFraction.MINUS_ONE;
	 ...
	 */
	public AetherInfinityTopplingAlternationCompliance2D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
	...
	public Boolean nextStep() {
		...
		BigFraction[][] newSourceGrid = new BigFraction[newSide][];
		grid = null;
		grid = Utils.buildAnisotropic2DBooleanArray(newSide);
		BigFraction currentValue, greaterXNeighborValue;
		BigFraction[] smallerXSlice = null, currentXSlice = sourceGrid[0], greaterXSlice = sourceGrid[1];
		...
		newXSlices[1] = newCurrentXSlice;
		newXSlices[2] = newGreaterXSlice;
		toppleRangeBeyondX2(xSlices, newXSlices, newSourceGrid, 3, edge, 
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newGreaterXSlice = new BigFraction[newSourceGrid.length];
			Arrays.fill(newGreaterXSlice, BigFraction.ZERO);
	...
	private void toppleRangeBeyondX2(BigFraction[][] xSlices, BigFraction[][] newXSlices, BigFraction[][] newSourceGrid, int minX, int maxX, 
