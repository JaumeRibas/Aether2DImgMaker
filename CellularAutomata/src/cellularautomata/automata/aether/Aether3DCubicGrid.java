 ...
 *
 */
public class Aether3DCubicGrid implements SymmetricLongModel3D, Serializable {
	 ...
	 * @param initialValue
	 */
	public Aether3DCubicGrid(int side, long initialValue) {
		if (side%2 == 0)
	 ...
	 */
	public Aether3DCubicGrid(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		Aether3DCubicGrid data = (Aether3DCubicGrid) Utils.deserializeFromFile(backupPath);
		grid = data.grid;
