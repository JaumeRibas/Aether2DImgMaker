 ...
 *
 */
public class BfAetherInfinity2D extends IsotropicSquareNumericArrayModelAsymmetricSection<BigFraction> {

	private final boolean isPositive;
	private long step;	
	private int maxX;
	
	public BfAetherInfinity2D(boolean isPositive) {
	 ...
	 */
	public BfAetherInfinity2D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
