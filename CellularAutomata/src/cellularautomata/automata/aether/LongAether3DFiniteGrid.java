 ...
 *
 */
public class LongAether3DFiniteGrid implements LongModel3D, Serializable {
	...
	public LongAether3DFiniteGrid(int xSide, int ySide, int zSide, long singleSourceValue) {
	 ...
	 */
	public LongAether3DFiniteGrid(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		LongAether3DFiniteGrid data = (LongAether3DFiniteGrid) Utils.deserializeFromFile(backupPath);
		grid = data.grid;
