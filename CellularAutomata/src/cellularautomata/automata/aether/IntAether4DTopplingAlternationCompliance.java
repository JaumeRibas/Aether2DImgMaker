...
public class IntAether4DTopplingAlternationCompliance implements SymmetricBooleanModel4D, IsotropicHypercubicModel4DA, Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2276260234300976195L;
	...
	public IntAether4DTopplingAlternationCompliance(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		IntAether4DTopplingAlternationCompliance data = (IntAether4DTopplingAlternationCompliance) Utils.deserializeFromFile(backupPath);
	...
	private static boolean topplePositionType1(int currentValue, int gWValue, int[][][] newCurrentWSlice, int[][][] newGreaterWSlice) {
