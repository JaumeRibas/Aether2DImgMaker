 ...
 *
 */
public class SimpleAether1DInfinityFiniteGrid implements NumericModel1D<BigFraction> {
	...
	public SimpleAether1DInfinityFiniteGrid(boolean isPositive, int side) {
		if (side < 1) {
