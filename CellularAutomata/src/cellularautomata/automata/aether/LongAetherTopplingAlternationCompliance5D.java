...
public class LongAetherTopplingAlternationCompliance5D extends IsotropicHypercubicBooleanArrayModelAsymmetricSection5D {
	 ...
	 */
	public LongAetherTopplingAlternationCompliance5D(long initialValue) {
		if (initialValue < MIN_INITIAL_VALUE) {//to prevent overflow of long type
			throw new IllegalArgumentException(String.format("Initial value cannot be smaller than %,d. Use a greater initial value or a different implementation.", MIN_INITIAL_VALUE));
		}
		this.initialValue = initialValue;
		itsEvenPositionsTurnToTopple = initialValue >= 0;
		sourceGrid = Utils.buildAnisotropic5DLongArray(9);
	 ...
	 */
	public LongAetherTopplingAlternationCompliance5D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
	...
	public Boolean nextStep() {
		...
		long[][][][] smallerVSlice = null, currentVSlice = sourceGrid[0], greaterVSlice = sourceGrid[1];
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newSourceGrid[sourceGrid.length] = Utils.buildAnisotropic4DLongArray(newSourceGrid.length);
		}
	...
	private boolean toppleRangeBeyondV5(long[][][][][] vSlices, long[][][][][] newVSlices, long[][][][][] newSourceGrid, int minV,
