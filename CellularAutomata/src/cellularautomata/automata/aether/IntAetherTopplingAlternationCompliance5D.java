...
public class IntAetherTopplingAlternationCompliance5D extends IsotropicHypercubicBooleanArrayModelAsymmetricSection5D {
	 ...
	 */
	public IntAetherTopplingAlternationCompliance5D(int initialValue) {
		...
		sourceGrid = Utils.buildAnisotropic5DIntArray(9);
		sourceGrid[0][0][0][0][0] = this.initialValue;
		maxV = 6;
		step = 0;
		nextStep();
	}
	 ...
	 */
	public IntAetherTopplingAlternationCompliance5D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		...
		sourceGrid = (int[][][][][]) data.get(SerializableModelData.GRID);
	...
	public Boolean nextStep() {
		...
		int[][][][][] newSourceGrid = new int[newSide][][][][];
		grid = null;
		grid = Utils.buildAnisotropic5DBooleanArray(newSide);
		boolean changed = false;
		int[][][][] smallerVSlice = null, currentVSlice = sourceGrid[0], greaterVSlice = sourceGrid[1];
		...
		boolean[][][][] newCurrentVSliceCompliance = grid[0]; 
		newSourceGrid[0] = newCurrentVSlice;
		newSourceGrid[1] = newGreaterVSlice;
		// 0 | 0 | 0 | 0 | 0 | 1
		...
		newCurrentVSliceCompliance = grid[3];
		newSourceGrid[4] = newGreaterVSlice;
		newVSlices[0] = newSmallerVSlice;
		newVSlices[1] = newCurrentVSlice;
		newVSlices[2] = newGreaterVSlice;
		...
		newCurrentVSliceCompliance = grid[4];
		newSourceGrid[5] = newGreaterVSlice;
		newVSlices[0] = newSmallerVSlice;
		newVSlices[1] = newCurrentVSlice;
		newVSlices[2] = newGreaterVSlice;
		...
		//v slice transition
		sourceGrid[3] = null;//free old grid progressively to save memory
		smallerVSlice = currentVSlice;
		currentVSlice = greaterVSlice;
		greaterVSlice = sourceGrid[6];
		vSlices[0] = smallerVSlice;
		vSlices[1] = currentVSlice;
		vSlices[2] = greaterVSlice;
		newSmallerVSlice = newCurrentVSlice;
		...
		newCurrentVSliceCompliance = grid[5];
		newSourceGrid[6] = newGreaterVSlice;
		newVSlices[0] = newSmallerVSlice;
		newVSlices[1] = newCurrentVSlice;
		newVSlices[2] = newGreaterVSlice;
		...
		if (toppleRangeBeyondV5(vSlices, newVSlices, newSourceGrid, 6, edgeMinusTwo, 
		...
		//edge - 2 <= v < edge
		if (toppleRangeBeyondV5(vSlices, newVSlices, newSourceGrid, edgeMinusTwo, edge, 
				relevantAsymmetricNeighborValues, sortedNeighborsIndexes, relevantAsymmetricNeighborCoords, relevantAsymmetricNeighborShareMultipliers, relevantAsymmetricNeighborSymmetryCounts)) {
			changed = true;
			maxV++;
		}
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newSourceGrid[sourceGrid.length] = Utils.buildAnisotropic4DIntArray(newSourceGrid.length);
		}
	...
	private void registerStaticGridSliceCompliance(int v) {
		if (v%2 == 0 == itsEvenPositionsTurnToTopple) {
			Utils.fillOddIndexes(grid[v], true);
		} else {
			Utils.fillEvenIndexes(grid[v], true);
		}
	}
	...
	private boolean toppleRangeBeyondV5(int[][][][][] vSlices, int[][][][][] newVSlices, int[][][][][] newSourceGrid, int minV,
		...
		for (; v != maxV; vMinusFour = vMinusThree, vMinusThree = vMinusTwo, vMinusTwo = vMinusOne, vMinusOne = v, v = vPlusOne, vPlusOne = vPlusTwo, vPlusTwo++, isVEven = !isVEven) {
			//v slice transition
			sourceGrid[vMinusTwo] = null;//free old grid progressively to save memory
			smallerVSlice = currentVSlice;
			currentVSlice = greaterVSlice;
			greaterVSlice = sourceGrid[vPlusOne];
			vSlices[0] = smallerVSlice;
			vSlices[1] = currentVSlice;
			vSlices[2] = greaterVSlice;
			newSmallerVSlice = newCurrentVSlice;
			...
			boolean[][][][] newCurrentVSliceCompliance = grid[v];
			newSourceGrid[vPlusOne] = newGreaterVSlice;
			newVSlices[0] = newSmallerVSlice;
			newVSlices[1] = newCurrentVSlice;
			newVSlices[2] = newGreaterVSlice;
			if (toppleRangeOfType11(vSlices, newVSlices, relevantAsymmetricNeighborValues, sortedNeighborsIndexes,
