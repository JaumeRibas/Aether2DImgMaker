...
public class IntAetherTopplingAlternationCompliance2D extends IsotropicSquareBooleanArrayModelAsymmetricSection {
	 ...
	 */
	public IntAetherTopplingAlternationCompliance2D(int initialValue) {
		...
		final int side = 6;
		sourceGrid = Utils.buildAnisotropic2DIntArray(side);
	 ...
	 */
	public IntAetherTopplingAlternationCompliance2D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
	...
	public Boolean nextStep() {
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newSourceGrid[sourceGrid.length] = new int[newSourceGrid.length];
		}
	...
	private boolean toppleRangeBeyondX2(int[][] xSlices, int[][] newXSlices, int[][] newSourceGrid, int minX, int maxX, 
