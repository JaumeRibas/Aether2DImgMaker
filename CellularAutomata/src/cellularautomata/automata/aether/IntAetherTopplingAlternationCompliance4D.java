...
public class IntAetherTopplingAlternationCompliance4D extends IsotropicHypercubicBooleanArrayModelAsymmetricSection4D {
	 ...
	 */
	public IntAetherTopplingAlternationCompliance4D(int initialValue) {
		...
		sourceGrid = Utils.buildAnisotropic4DIntArray(8);
	 ...
	 */
	public IntAetherTopplingAlternationCompliance4D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
	...
	public Boolean nextStep() {
		...
		int[][][] smallerWSlice = null, currentWSlice = sourceGrid[0], greaterWSlice = sourceGrid[1];
		...
		if (newSourceGrid.length > sourceGrid.length) {
			newSourceGrid[sourceGrid.length] = Utils.buildAnisotropic3DIntArray(newSourceGrid.length);
		}
	...
	private boolean toppleRangeBeyondW4(int[][][][] wSlices, int[][][][] newWSlices, int[][][][] newSourceGrid, int minW,
