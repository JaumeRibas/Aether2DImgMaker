...
/**
 * Implementation of the <a href="https://github.com/JaumeRibas/Aether2DImgMaker/wiki/Aether-Cellular-Automaton-Definition">Aether</a> cellular automaton in 2D with a single source initial configuration of infinity
 * 
 * @author Jaume
 *
 */
public class Aether2DInfinity implements SymmetricNumericModel2D<BigFraction>, IsotropicSquareModelA, Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7622600244531619169L;
	...
	public Aether2DInfinity(boolean isPositive) {
		this.isPositive = isPositive;
		grid = Utils.buildAnisotropic2DBigFractionArray(6);
	 ...
	 */
	public Aether2DInfinity(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		Aether2DInfinity data = (Aether2DInfinity) Utils.deserializeFromFile(backupPath);
