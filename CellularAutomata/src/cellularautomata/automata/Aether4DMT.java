...
public class Aether4DMT extends SymmetricLongCellularAutomaton4D {
	 ...
	 */
	public Aether4DMT(long initialValue, long backgroundValue, int threadCount) {
	 ...
	 */
	public Aether4DMT(CustomSymmetricLongCA4DData data, int threadCount) {
		this.threadCount = threadCount;
	...
	class Aether4DComputer implements Callable<ComputingResult> {
		...
		public Aether4DComputer(long[][][][] grid, long[][][][] newGrid, int start, int finish) {
			this.grid = grid;
