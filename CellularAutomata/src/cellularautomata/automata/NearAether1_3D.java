...
public class NearAether1_3D implements SymmetricLongCellularAutomaton3D {
	 ...
	 */
	public NearAether1_3D(long initialValue) {
		if (initialValue < 0) {
	 ...
	 */
	public NearAether1_3D(String backupPath) throws FileNotFoundException, ClassNotFoundException, IOException {
		NearAether1_3D data = (NearAether1_3D) Utils.deserializeFromFile(backupPath);
