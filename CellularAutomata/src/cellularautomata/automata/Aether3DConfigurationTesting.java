...
public class Aether3DConfigurationTesting extends LongCellularAutomaton3D {	
	 ...
	 */
	public Aether3DConfigurationTesting(long[][][] initialConfiguration, String initialConfigurationName) {
		this.initialConfigurationName = initialConfigurationName;
		grid = initialConfiguration;
		originIndex = (initialConfiguration.length - 1)/2;
	}
	...
	/**
	 * Returns the name of the initial configuration
	 * 
