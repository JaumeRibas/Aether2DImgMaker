...
import cellularautomata.grid2d.LongSubGrid2D;

public class EvolvingLongSubGrid2D extends LongSubGrid2D<EvolvingLongGrid2D> implements EvolvingLongGrid2D {
	...
	public EvolvingLongSubGrid2D(EvolvingLongGrid2D source, int minX, int maxX, int minY, int maxY) {
