 ...
 *
 */
public class ArrayNumberGrid2D<T extends FieldElement<T> & Comparable<T>> implements NumberGrid2D<T> {
	 ...
	 */
	public ArrayNumberGrid2D(int minX, int[] localYMinima, Object[][] values) {
