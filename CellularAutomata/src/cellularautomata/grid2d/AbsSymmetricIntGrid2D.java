...
public class AbsSymmetricIntGrid2D implements SymmetricIntGrid2D {
	
	private SymmetricIntGrid2D source;
	
	public AbsSymmetricIntGrid2D(SymmetricIntGrid2D source) {
		this.source = source;
	}
	...
	@Override
	public int getValueAtNonSymmetricPosition(int x, int y) throws Exception {
		return Math.abs(source.getValueAtNonSymmetricPosition(x, y));
	}
