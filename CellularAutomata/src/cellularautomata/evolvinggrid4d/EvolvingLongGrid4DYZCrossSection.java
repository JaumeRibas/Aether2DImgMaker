...
import cellularautomata.grid4d.LongGrid4DYZCrossSection;

public class EvolvingLongGrid4DYZCrossSection extends LongGrid4DYZCrossSection<EvolvingLongGrid4D> implements EvolvingLongGrid2D {

	public EvolvingLongGrid4DYZCrossSection(EvolvingLongGrid4D source, int y, int z) {
		super(source, y, z);
	}
