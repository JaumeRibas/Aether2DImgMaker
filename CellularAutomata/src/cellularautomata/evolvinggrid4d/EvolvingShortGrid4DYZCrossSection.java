...
import cellularautomata.grid4d.ShortGrid4DYZCrossSection;

public class EvolvingShortGrid4DYZCrossSection extends ShortGrid4DYZCrossSection<EvolvingShortGrid4D> implements EvolvingShortGrid2D {

	public EvolvingShortGrid4DYZCrossSection(EvolvingShortGrid4D source, int y, int z) {
		super(source, y, z);
	}
