...
public class CustomHypercubicIntArrayModel4DDelta implements SymmetricLongModel4D, IsotropicHypercubicModel4DA {	

	private int[][][][] oldGrid;
	private IsotropicHypercubicIntArrayModel4DA model;
	private int sizeDifference;

	public CustomHypercubicIntArrayModel4DDelta(IsotropicHypercubicIntArrayModel4DA model) throws Exception {
		this.model = model;
		nextStep();
	}
