...
public class CustomHypercubicLongArrayModel4DDelta implements SymmetricNumericModel4D<BigInt>, IsotropicHypercubicModel4DA {	

	private long[][][][] oldGrid;
	private IsotropicHypercubicLongArrayModel4DA model;
	private int sizeDifference;

	public CustomHypercubicLongArrayModel4DDelta(IsotropicHypercubicLongArrayModel4DA model) throws Exception {
		this.model = model;
		nextStep();
	}
