...
public class CustomHypercubicNumericArrayModel4DDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements SymmetricNumericModel4D<Number_Type>, IsotropicHypercubicModel4DA {	

	private Number_Type[][][][] oldGrid;
	private IsotropicHypercubicNumericArrayModel4DA<Number_Type> model;
	private int sizeDifference;

	public CustomHypercubicNumericArrayModel4DDelta(IsotropicHypercubicNumericArrayModel4DA<Number_Type> model) throws Exception {
		this.model = model;
		nextStep();
	}
