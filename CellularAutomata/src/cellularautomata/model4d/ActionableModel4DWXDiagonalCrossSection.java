...
public class ActionableModel4DWXDiagonalCrossSection<G1 extends Grid4D, G2 extends Grid3D> 
	...
	private class InternalProcessor implements GridProcessor<G1> {
		...
		public void processGridBlock(G1 gridBlock) throws Exception {
			...
			if (w <= maxW) {
				triggerProcessGridBlock((G2) gridBlock.diagonalCrossSectionOnWX(xOffsetFromW));
			}
		}
