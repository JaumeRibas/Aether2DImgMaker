...
/**
 * Represents a hyperrectangular region of a 4D grid backed by a 4D array.
 * 
 * @author Jaume
 *
 */
public abstract class HyperrectangularArrayGrid4D implements Model4D {
	...
	/**
	 * Constructs a {@code HyperrectangularArrayGrid4D}
	 * 
	 ...
	 */
	public HyperrectangularArrayGrid4D(int minW, int minX, int minY, int minZ) {
		this.minW = minW;
		this.minX = minX;
		this.minY = minY;
		this.minZ = minZ;
	...
	protected void setMaxCoordinates(int arrayWSide, int arrayXSide, int arrayYSide, int arrayZSide) {
		long maxCoord = (long)arrayWSide + minW - 1;
