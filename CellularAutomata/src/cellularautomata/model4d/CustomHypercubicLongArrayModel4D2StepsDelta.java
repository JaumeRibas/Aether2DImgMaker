...
public class CustomHypercubicLongArrayModel4D2StepsDelta implements SymmetricNumericModel4D<BigInt>, IsotropicHypercubicModel4DA {	

	private long[][][][] previousStepGrid;
	private long[][][][] stepBeforePreviousGrid;
	private IsotropicHypercubicLongArrayModel4DA model;
	private int sizeDifference;

	public CustomHypercubicLongArrayModel4D2StepsDelta(IsotropicHypercubicLongArrayModel4DA model) throws Exception {
		this.model = model;
