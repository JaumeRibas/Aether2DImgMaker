...
public class CustomIsotropicLongArrayModel4D2StepsDelta implements IsotropicHypercubicNumericModelAsymmetricSection4D<BigInt> {	

	private final IsotropicHypercubicLongArrayModelAsymmetricSection4D model;
	...
	public CustomIsotropicLongArrayModel4D2StepsDelta(IsotropicHypercubicLongArrayModelAsymmetricSection4D model) throws Exception {
		this.model = model;
	...
	public BigInt getFromPosition(int w, int x, int y, int z) {
		return BigInt.valueOf(model.grid[w][x][y][z]).subtract(BigInt.valueOf(stepBeforePreviousGrid[w][x][y][z]));
	}
