...
public class CustomIsotropicNumericArrayModel4D2StepsDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements IsotropicHypercubicNumericModelAsymmetricSection4D<Number_Type> {	
	...
	public CustomIsotropicNumericArrayModel4D2StepsDelta(IsotropicHypercubicNumericArrayModelAsymmetricSection4D<Number_Type> model) throws Exception {
		this.model = model;
