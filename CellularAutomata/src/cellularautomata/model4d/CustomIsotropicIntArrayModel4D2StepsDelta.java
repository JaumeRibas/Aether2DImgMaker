...
public class CustomIsotropicIntArrayModel4D2StepsDelta implements IsotropicHypercubicLongModelAsymmetricSection4D {	
	...
	public CustomIsotropicIntArrayModel4D2StepsDelta(IsotropicHypercubicIntArrayModelAsymmetricSection4D model) throws Exception {
		this.model = model;
