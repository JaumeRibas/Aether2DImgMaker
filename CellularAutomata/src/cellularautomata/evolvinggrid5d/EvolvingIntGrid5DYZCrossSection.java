...
import cellularautomata.grid5d.IntGrid5DYZCrossSection;

public class EvolvingIntGrid5DYZCrossSection extends IntGrid5DYZCrossSection<EvolvingIntGrid5D> implements EvolvingIntGrid3D {

	public EvolvingIntGrid5DYZCrossSection(EvolvingIntGrid5D source, int y, int z) {
		super(source, y, z);
	}
