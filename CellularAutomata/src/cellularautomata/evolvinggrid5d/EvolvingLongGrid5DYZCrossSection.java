...
import cellularautomata.grid5d.LongGrid5DYZCrossSection;

public class EvolvingLongGrid5DYZCrossSection extends LongGrid5DYZCrossSection<EvolvingLongGrid5D> implements EvolvingLongGrid3D {

	public EvolvingLongGrid5DYZCrossSection(EvolvingLongGrid5D source, int y, int z) {
		super(source, y, z);
	}
