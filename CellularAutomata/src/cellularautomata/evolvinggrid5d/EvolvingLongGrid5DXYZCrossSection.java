...
import cellularautomata.grid5d.LongGrid5DXYZCrossSection;

public class EvolvingLongGrid5DXYZCrossSection extends LongGrid5DXYZCrossSection<EvolvingLongGrid5D> implements EvolvingLongGrid2D {

	public EvolvingLongGrid5DXYZCrossSection(EvolvingLongGrid5D source, int x, int y, int z) {
		super(source, x, y, z);
	}
