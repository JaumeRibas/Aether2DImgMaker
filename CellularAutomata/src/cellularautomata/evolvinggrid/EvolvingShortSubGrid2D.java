...
import cellularautomata.grid2d.ShortSubGrid2D;

public class EvolvingShortSubGrid2D extends ShortSubGrid2D<EvolvingShortGrid2D> implements EvolvingShortGrid2D {
	...
	public EvolvingShortSubGrid2D(EvolvingShortGrid2D source, int minX, int maxX, int minY, int maxY) {
