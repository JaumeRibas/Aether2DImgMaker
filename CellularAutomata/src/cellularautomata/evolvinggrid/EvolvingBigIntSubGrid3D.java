...
import cellularautomata.grid3d.BigIntSubGrid3D;

public class EvolvingBigIntSubGrid3D extends BigIntSubGrid3D<EvolvingBigIntGrid3D> implements EvolvingBigIntGrid3D {
	...
	public EvolvingBigIntSubGrid3D(EvolvingBigIntGrid3D source, int minX, int maxX, int minY, int maxY, int minZ, int maxZ) {
