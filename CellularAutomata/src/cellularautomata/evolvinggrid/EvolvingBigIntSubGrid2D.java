...
import cellularautomata.grid2d.BigIntSubGrid2D;

public class EvolvingBigIntSubGrid2D extends BigIntSubGrid2D<EvolvingBigIntGrid2D> implements EvolvingBigIntGrid2D {
	...
	public EvolvingBigIntSubGrid2D(EvolvingBigIntGrid2D source, int minX, int maxX, int minY, int maxY) {
