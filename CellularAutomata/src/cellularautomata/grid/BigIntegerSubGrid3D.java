...
public class BigIntegerSubGrid3D extends BigIntegerGrid3D {
	
	private BigIntegerGrid3D source;
	private int minX;
	private int maxX;
	private int minY;
	private int maxY;
	...
	public BigIntegerSubGrid3D(BigIntegerGrid3D source, int minX, int maxX, 
