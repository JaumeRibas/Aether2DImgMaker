...
public abstract class ShortGrid2D implements Grid2D, ShortGrid {
	...
	public ShortGrid2D absoluteGrid() {
		return new AbsShortGrid2D(this);
	}
	
	public ShortGrid2D subGrid(int minX, int maxX, int minY, int maxY) {
		return subGrid(minX, maxX, minY, maxY, false);
	}
	
	public ShortGrid2D subGrid(int minX, int maxX, int minY, int maxY, boolean allowOverflow) {
