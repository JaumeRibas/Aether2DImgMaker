...
public class AbsSymmetricShortGrid2D extends SymmetricShortGrid2D {
	...
	@Override
	public short getNonSymmetricValue(int x, int y) {
		return (short) Math.abs(source.getNonSymmetricValue(x, y));
	}
