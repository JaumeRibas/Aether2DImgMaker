...
public class AbsSymmetricShortGrid4D extends SymmetricShortGrid4D {
	...
	public short getValueAt(int w, int x, int y, int z) {
		return (short) Math.abs(source.getValueAt(w, x, y, z));
	}
	...
	public short getNonSymmetricValueAt(int w, int x, int y, int z) {
		return (short) Math.abs(source.getNonSymmetricValueAt(w, x, y, z));
	}
