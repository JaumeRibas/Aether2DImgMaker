...
public class AbsSymmetricShortGrid4D extends SymmetricShortGrid4D {
	...
	public short getValue(int w, int x, int y, int z) {
		return (short) Math.abs(source.getValue(w, x, y, z));
	}
	...
	@Override
	public short getNonSymmetricValue(int w, int x, int y, int z) {
		return (short) Math.abs(source.getNonSymmetricValue(w, x, y, z));
	}
