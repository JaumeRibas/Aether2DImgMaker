...
public interface IntGrid extends SequentialIntGrid {
	...
	default int[] getEvenPositionsMinAndMax() throws Exception {
		IntGridMinAndMaxCoordinateConsumer consumer = new IntGridMinAndMaxCoordinateConsumer(this);
...
//			int localHorizontalMarginUpperEnd = maxHorizontalCoordinate - localMaxHorizontalCoordinate;
	...
	default Iterator<Integer> iterator() {
		return new IntGridIterator(this);
	}
