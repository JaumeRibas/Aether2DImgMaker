...
public class AbsSymmetricIntGrid3D extends SymmetricIntGrid3D {
	...
	@Override
	public int getNonSymmetricValue(int x, int y, int z) throws Exception {
		return Math.abs(source.getNonSymmetricValue(x, y, z));
	}
