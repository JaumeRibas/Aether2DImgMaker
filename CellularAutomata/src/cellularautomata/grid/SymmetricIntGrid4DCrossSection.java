...
public class SymmetricIntGrid4DCrossSection extends SymmetricIntGrid2D {

	private SymmetricIntGrid4D source;
	private int y;
	private int z;
	
	public SymmetricIntGrid4DCrossSection(SymmetricIntGrid4D source, int y, int z) {
		this.source = source;
		this.y = y;
		this.z = z;
	}
	...
	@Override
	public int getNonSymmetricValue(int x, int y) {
