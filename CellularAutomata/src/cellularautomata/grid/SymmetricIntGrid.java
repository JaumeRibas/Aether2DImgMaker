...
public interface SymmetricIntGrid extends IntGrid, SymmetricGrid {
	
	@Override
	default IntGrid asymmetricSection() {
		return new AsymmetricIntGridSection<SymmetricIntGrid>(this);
	}
