...
public class CustomIsotropicNumericArrayModel2D2StepsDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements IsotropicSquareNumericModelAsymmetricSection<Number_Type> {	
	...
	public CustomIsotropicNumericArrayModel2D2StepsDelta(IsotropicSquareNumericArrayModelAsymmetricSection<Number_Type> model) throws Exception {
		this.model = model;
