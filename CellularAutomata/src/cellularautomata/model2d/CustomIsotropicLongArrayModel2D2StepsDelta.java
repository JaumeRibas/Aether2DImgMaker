...
public class CustomIsotropicLongArrayModel2D2StepsDelta implements IsotropicSquareNumericModelAsymmetricSection<BigInt> {	
	...
	public CustomIsotropicLongArrayModel2D2StepsDelta(IsotropicSquareLongArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
