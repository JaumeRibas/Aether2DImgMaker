...
public class CustomIsotropicIntArrayModel2D2StepsDelta implements IsotropicSquareLongModelAsymmetricSection {	

	private final IsotropicSquareIntArrayModelAsymmetricSection model;
	...
	public CustomIsotropicIntArrayModel2D2StepsDelta(IsotropicSquareIntArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
	...
	public long getFromPosition(int x, int y) {
		return (long)model.grid[x][y] - stepBeforePreviousGrid[x][y];
	}
