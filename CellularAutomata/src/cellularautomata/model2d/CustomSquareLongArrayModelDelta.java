...
public class CustomSquareLongArrayModelDelta implements SymmetricNumericModel2D<BigInt>, IsotropicSquareModelA {	

	private long[][] oldGrid;
	private IsotropicSquareLongArrayModelA model;
	private int sizeDifference;

	public CustomSquareLongArrayModelDelta(IsotropicSquareLongArrayModelA model) throws Exception {
		this.model = model;
		nextStep();
	}
