...
public class CustomSquareIntArrayModel2StepsDelta implements SymmetricLongModel2D, IsotropicSquareModelA {	
	...
	public CustomSquareIntArrayModel2StepsDelta(IsotropicSquareIntArrayModelA model) throws Exception {
		this.model = model;
