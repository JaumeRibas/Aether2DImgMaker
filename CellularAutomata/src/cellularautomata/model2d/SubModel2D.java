...
import cellularautomata.grid2d.SubGrid2D;

public class SubModel2D<M extends Model2D> extends SubGrid2D<M> implements Model2D {
	...
	public SubModel2D(M source, int minX, int maxX, int minY, int maxY) {
