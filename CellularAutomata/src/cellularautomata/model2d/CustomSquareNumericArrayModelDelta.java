...
public class CustomSquareNumericArrayModelDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements SymmetricNumericModel2D<Number_Type>, IsotropicSquareModelA {	

	private Number_Type[][] oldGrid;
	private IsotropicSquareNumericArrayModelA<Number_Type> model;
	private int sizeDifference;

	public CustomSquareNumericArrayModelDelta(IsotropicSquareNumericArrayModelA<Number_Type> model) throws Exception {
		this.model = model;
		nextStep();
	}
