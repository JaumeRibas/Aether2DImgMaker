...
public class ObjectArrayGrid2D<Object_Type> extends ArrayGrid2D implements ObjectModel2D<Object_Type>, Serializable {
	...
	/**
	 * Constructs an {@code ObjectArrayGrid2D} with the specified bounds
	 * 
	 ...
	 */
	public ObjectArrayGrid2D(int minX, int[] localYMinima, Object_Type[][] values) {
