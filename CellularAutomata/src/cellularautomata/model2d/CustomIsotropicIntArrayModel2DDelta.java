...
public class CustomIsotropicIntArrayModel2DDelta implements IsotropicSquareLongModelAsymmetricSection {	

	private final IsotropicSquareIntArrayModelAsymmetricSection model;
	private int[][] oldGrid;
	private int size;

	public CustomIsotropicIntArrayModel2DDelta(IsotropicSquareIntArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
		nextStep();
	}
