...
public interface SymmetricBooleanModel2D extends BooleanModel2D, SymmetricModel2D, SymmetricBooleanModel {
	...
	@Override
	default BooleanModel2D asymmetricSection() {
		return new AsymmetricBooleanModelSection2D(this);
	}
}
