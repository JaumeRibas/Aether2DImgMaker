...
public class CustomCubicIntArrayModelDelta implements SymmetricLongModel3D, IsotropicCubicModelA {	

	private int[][][] oldGrid;
	private IsotropicCubicIntArrayModelA model;
	private int sizeDifference;

	public CustomCubicIntArrayModelDelta(IsotropicCubicIntArrayModelA model) throws Exception {
		this.model = model;
		nextStep();
	}
