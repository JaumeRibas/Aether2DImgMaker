...
public class CustomCubicLongArrayModel2StepsDelta implements SymmetricNumericModel3D<BigInt>, IsotropicCubicModelA {	

	private long[][][] previousStepGrid;
	private long[][][] stepBeforePreviousGrid;
	private IsotropicCubicLongArrayModelA model;
	private int sizeDifference;

	public CustomCubicLongArrayModel2StepsDelta(IsotropicCubicLongArrayModelA model) throws Exception {
		this.model = model;
