...
public class CustomIsotropicNumericArrayModel3DDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements IsotropicCubicNumericModelAsymmetricSection<Number_Type> {	

	private final IsotropicCubicNumericArrayModelAsymmetricSection<Number_Type> model;
	private Number_Type[][][] oldGrid;
	private int size;

	public CustomIsotropicNumericArrayModel3DDelta(IsotropicCubicNumericArrayModelAsymmetricSection<Number_Type> model) throws Exception {
		this.model = model;
		nextStep();
	}
