...
public class CustomIsotropicNumericArrayModel3D2StepsDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements IsotropicCubicNumericModelAsymmetricSection<Number_Type> {	

	private final IsotropicCubicNumericArrayModelAsymmetricSection<Number_Type> model;
	...
	public CustomIsotropicNumericArrayModel3D2StepsDelta(IsotropicCubicNumericArrayModelAsymmetricSection<Number_Type> model) throws Exception {
		this.model = model;
	...
	public Number_Type getFromPosition(int x, int y, int z) {
		return model.grid[x][y][z].subtract(stepBeforePreviousGrid[x][y][z]);
	}
