...
public class CustomCubicLongArrayModelDelta implements SymmetricNumericModel3D<BigInt>, IsotropicCubicModelA {	

	private long[][][] oldGrid;
	private IsotropicCubicLongArrayModelA model;
	private int sizeDifference;

	public CustomCubicLongArrayModelDelta(IsotropicCubicLongArrayModelA model) throws Exception {
		this.model = model;
		nextStep();
	}
