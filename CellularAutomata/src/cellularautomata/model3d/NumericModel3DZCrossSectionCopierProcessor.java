...
public class NumericModel3DZCrossSectionCopierProcessor<T extends FieldElement<T> & Comparable<T>> implements ModelProcessor<NumericModel3D<T>> {
	...
	public NumericModel2D<T> getCopy(int crossSectionZ) {
