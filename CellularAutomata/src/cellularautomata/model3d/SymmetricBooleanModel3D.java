...
public interface SymmetricBooleanModel3D extends BooleanModel3D, SymmetricModel3D, SymmetricBooleanModel {
	 ...
	 * @throws Exception 
	 */
	boolean getFromAsymmetricPosition(int x, int y, int z) throws Exception;
	...
	@Override
	default BooleanModel3D asymmetricSection() {
		return new AsymmetricBooleanModelSection3D(this);
	}
}
