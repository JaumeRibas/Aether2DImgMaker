...
public class CustomCubicBooleanArrayModelDelta implements SymmetricBooleanModel3D, IsotropicCubicModelA {	

	private boolean[][][] oldGrid;
	private IsotropicCubicBooleanArrayModelA model;
	private int sizeDifference;

	public CustomCubicBooleanArrayModelDelta(IsotropicCubicBooleanArrayModelA model) throws Exception {
		this.model = model;
		nextStep();
	}
