...
public class CustomCubicNumericArrayModel2StepsDelta<Number_Type extends FieldElement<Number_Type> & Comparable<Number_Type>> implements SymmetricNumericModel3D<Number_Type>, IsotropicCubicModelA {	
	...
	public CustomCubicNumericArrayModel2StepsDelta(IsotropicCubicNumericArrayModelA<Number_Type> model) throws Exception {
		this.model = model;
