...
public class IsotropicCubicObjectModel<AsymmetricSection_Type extends IsotropicCubicObjectModelAsymmetricSection<Object_Type>, Object_Type> extends IsotropicCubicModel<AsymmetricSection_Type> implements ObjectModel3D<Object_Type> {
	
	public IsotropicCubicObjectModel(AsymmetricSection_Type asymmetricSection) {
