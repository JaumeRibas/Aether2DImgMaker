...
public class CustomIsotropicLongArrayModel3D2StepsDelta implements IsotropicCubicNumericModelAsymmetricSection<BigInt> {	

	private final IsotropicCubicLongArrayModelAsymmetricSection model;
	...
	public CustomIsotropicLongArrayModel3D2StepsDelta(IsotropicCubicLongArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
	...
	public BigInt getFromPosition(int x, int y, int z) {
		return BigInt.valueOf(model.grid[x][y][z]).subtract(BigInt.valueOf(stepBeforePreviousGrid[x][y][z]));
	}
