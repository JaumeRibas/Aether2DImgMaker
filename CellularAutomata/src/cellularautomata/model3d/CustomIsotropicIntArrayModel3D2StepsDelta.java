...
public class CustomIsotropicIntArrayModel3D2StepsDelta implements IsotropicCubicLongModelAsymmetricSection {	

	private final IsotropicCubicIntArrayModelAsymmetricSection model;
	...
	public CustomIsotropicIntArrayModel3D2StepsDelta(IsotropicCubicIntArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
	...
	public long getFromPosition(int x, int y, int z) {
		return (long)model.grid[x][y][z] - stepBeforePreviousGrid[x][y][z];
	}
