...
public class CustomIsotropicIntArrayModel3DDelta implements IsotropicCubicLongModelAsymmetricSection {	

	private final IsotropicCubicIntArrayModelAsymmetricSection model;
	private int[][][] oldGrid;
	private int size;

	public CustomIsotropicIntArrayModel3DDelta(IsotropicCubicIntArrayModelAsymmetricSection model) throws Exception {
		this.model = model;
		nextStep();
	}
	...
	public long getFromPosition(int x, int y, int z) {
		return (long)model.grid[x][y][z] - oldGrid[x][y][z];
	}
