...
public class CustomCubicIntArrayModel2StepsDelta implements SymmetricLongModel3D, IsotropicCubicModelA {	

	private int[][][] previousStepGrid;
	private int[][][] stepBeforePreviousGrid;
	private IsotropicCubicIntArrayModelA model;
	private int sizeDifference;

	public CustomCubicIntArrayModel2StepsDelta(IsotropicCubicIntArrayModelA model) throws Exception {
		this.model = model;
