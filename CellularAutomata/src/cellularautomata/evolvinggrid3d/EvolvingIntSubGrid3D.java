...
public class EvolvingIntSubGrid3D extends IntSubGrid3D<EvolvingIntGrid3D> implements EvolvingIntGrid3D {
	...
	public EvolvingIntSubGrid3D(EvolvingIntGrid3D source, int minX, int maxX, int minY, int maxY, int minZ, int maxZ) {
